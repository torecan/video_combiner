...
int main(int argc, char** argv) {
	...
	CvCapture* capture2 = cvCreateFileCapture("C://Users//t.celik//Desktop//FCB_Mobil_Stadium_Vision_Animation_2088x192px_01_32.mp4");
	CvCapture* capture3= cvCreateFileCapture("C://Users//t.celik//Desktop//Allianz_Family_Entrance.mp4");
	CvCapture* capture4 = cvCreateFileCapture("C://Users//t.celik//Desktop//Allianz_Family_Entrance.mp4");


	img = cvQueryFrame(capture);
	img1 = cvQueryFrame(capture2);
	img4= cvQueryFrame(capture3);
	img5 = cvQueryFrame(capture4);
	IplImage* img6 = cvLoadImage("C://Users//t.celik//Desktop//tests.png");
